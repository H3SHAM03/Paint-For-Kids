...
{	
	...
	if(UI.InterfaceMode == MODE_DRAW)	//GUI in the DRAW mode
	{
		...
		{	
			...
			case ITM_GAMEMODE: return TO_PLAY;
			case ITM_EXIT: return EXIT;
			case ITM_SQUA: return DRAW_SQUA;
			case ITM_TRIA: return DRAW_TRIA;
			case ITM_CIRC: return DRAW_CIRC;
			case ITM_SELECT: return SELECT_ONE;
			case ITM_BCOLOR: return CHANGE_DRAW_CLR;
			case ITM_FILL: return CHANGE_FILL_CLR;
			case ITM_BLACK: return BLACK_CLR;
			case ITM_YELLOW: return YELLOW_CLR;
			case ITM_ORANGE: return ORANGE_CLR;
			case ITM_RED: return RED_CLR;
			case ITM_GREEN: return GREEN_CLR;
			case ITM_BLUE: return BLUE_CLR;
			case ITM_DELETE: return DELETE_ITM;
			case ITM_MOVE: return MOVE_ITM;
			case ITM_UNDO: return UNDO;
			case ITM_REDO: return REDO;

			case ITM_CLEAR: return CLEAR;
			case ITM_RECORD: return START_REC;
			case ITM_STOP: return STOP_REC;
	...
	else	//GUI is in PLAY mode
	{
		...
		if (y >= 0 && y < UI.ToolBarHeight)
		{
			...
			case ITM_COLORS: return COLORS;
			case ITM_COLOREDFIGURES: return COLOREDFIGURES;
